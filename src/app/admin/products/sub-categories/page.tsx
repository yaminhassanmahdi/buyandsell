...
export default function AdminManageSubCategoriesPage() {
  ...
  const handleDeleteSubCategory = (subCategoryId: string) => {
    // In a real app, check for products associated with this sub-category.
  ...
  const handleEditSubCategory = (id: string) => {
    toast({ title: "Edit Action", description: `Edit sub-category ${id} (Not implemented).` });
  };
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Enter the name for the new sub-category.</DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="subcategory-name" className="text-right">Name</Label>
                <Input 
                  id="subcategory-name" 
